...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "faxNormalized", GoGetter: "FaxNormalized"},
			...
			_jsii_.MemberProperty{JsiiProperty: "phoneNormalized", GoGetter: "PhoneNormalized"},
			...
			_jsii_.MemberProperty{JsiiProperty: "stateProvince", GoGetter: "StateProvince"},
			_jsii_.MemberProperty{JsiiProperty: "stateProvinceInput", GoGetter: "StateProvinceInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-dnsimple.contact.ContactConfig",
		reflect.TypeOf((*ContactConfig)(nil)).Elem(),
	)
}
