...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "nameNormalized", GoGetter: "NameNormalized"},
			...
			_jsii_.MemberProperty{JsiiProperty: "valueNormalized", GoGetter: "ValueNormalized"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-dnsimple.zoneRecord.ZoneRecordConfig",
