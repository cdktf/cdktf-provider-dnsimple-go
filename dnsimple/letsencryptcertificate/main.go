...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-dnsimple.letsEncryptCertificate.LetsEncryptCertificateConfig",
		reflect.TypeOf((*LetsEncryptCertificateConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-dnsimple.letsEncryptCertificate.LetsEncryptCertificateTimeouts",
