...
import (
	...
	"github.com/cdktf/cdktf-provider-dnsimple-go/dnsimple/v9/emailforward/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/dnsimple/dnsimple/1.9.0/docs/resources/email_forward dnsimple_email_forward}.
...
// Create a new {@link https://registry.terraform.io/providers/dnsimple/dnsimple/1.9.0/docs/resources/email_forward dnsimple_email_forward} Resource.
...
func EmailForward_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateEmailForward_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EmailForward) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_EmailForward) HasResourceMove() interface{} {
	var returns interface{}
...
func (e *jsiiProxy_EmailForward) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_EmailForward) MoveFromId(id *string) {
...
func (e *jsiiProxy_EmailForward) MoveTo(moveTarget *string, index interface{}) {
...
func (e *jsiiProxy_EmailForward) MoveToId(id *string) {
...
func (e *jsiiProxy_EmailForward) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_EmailForward) ToHclTerraform() interface{} {
	var returns interface{}
