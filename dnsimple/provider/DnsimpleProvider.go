...
import (
	...
	"github.com/cdktf/cdktf-provider-dnsimple-go/dnsimple/v9/provider/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/dnsimple/dnsimple/1.8.0/docs dnsimple}.
...
// Create a new {@link https://registry.terraform.io/providers/dnsimple/dnsimple/1.8.0/docs dnsimple} Resource.
...
func DnsimpleProvider_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDnsimpleProvider_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DnsimpleProvider) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DnsimpleProvider) ToHclTerraform() interface{} {
	var returns interface{}
